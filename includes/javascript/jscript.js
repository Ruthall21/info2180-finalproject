...
function loadContacts(filter = 'all') {
    ...
    xhr.open('GET', 'dashboard.php?action=get_contacts&filter=' + encodeURIComponent(filter), true);
...
function displayContacts(contacts) {
    ...
    tbody.innerHTML = contacts.map(contact => {
        ...
        // Choose badge class; badge text will be the full type name
        ...
        // Use full type string inside the badge
        ...
        <tr>
            ...
            <td class="type-cell">
                <span class="${badgeClass}" title="${type}">${badgeText}</span>
            </td>
